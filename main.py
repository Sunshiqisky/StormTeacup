...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            writer.add_scalar(str(phase) + '/Loss', epoch_loss, epoch)
            writer.add_scalar(str(phase) + '/Accuracy', epoch_acc, epoch)
...
model_ft.Linear = nn.Linear(4096, 2)
...
torch.save(model_ft.state_dict(), 'best.pkl')
